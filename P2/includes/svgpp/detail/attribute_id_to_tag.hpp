...
#include "../../../includes/svgpp/definitions.hpp"
...
inline bool css_id_to_tag(attribute_id id, F & fn)
{
  switch (id)
  {
#include "../../../includes/svgpp/detail/dict/enumerate_presentation_attributes.inc"
    default:
      return false;
  }
  return true;
...
inline bool attribute_id_to_tag(tag::element::a, attribute_id id, F & fn)
{
  switch (id)
  {
#include "../../../includes/svgpp/detail/dict/enumerate_conditional_processing_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_core_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_graphical_event_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_presentation_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_xlink_attributes.inc"
    SVGPP_ON(class_)
    SVGPP_ON(style)
...
#include "../../../includes/svgpp/detail/dict/enumerate_presentation_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_xlink_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_animation_event_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_animation_attribute_target_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_animation_timing_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_animation_value_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_animation_addition_attributes.inc"
    SVGPP_ON(externalResourcesRequired)
    default:
      return false;
  }
...
#include "../../../includes/svgpp/detail/dict/enumerate_core_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_presentation_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_filter_primitive_attributes.inc"
    SVGPP_ON(class_)
    SVGPP_ON(style)
    SVGPP_ON(in)
    SVGPP_ON(in2)
    ...
    tag::element::feFuncA, tag::element::feFuncB, tag::element::feFuncR, tag::element::feFuncG>::type, ElementTag> >::type * = 0)
{
  ...
  {
#include "../../../includes/svgpp/detail/dict/enumerate_core_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_transfer_function_element_attributes.inc"
    default:
      return false;
  }
  return true;
...
#include "../../../includes/svgpp/detail/dict/enumerate_conditional_processing_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_core_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_document_event_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_graphical_event_attributes.inc"
#include "../../../includes/svgpp/detail/dict/enumerate_presentation_attributes.inc"
    SVGPP_ON(class_)
    SVGPP_ON(style)
