...
TEST(SweepLine, TestMehrfachschnittpunkt) {
	Line line1(new Point(160, 80), new Point(280, 200));
	Line line2(new Point(170, 160), new Point(270, 120));
	Line line3(new Point(120, 240), new Point(320, 40));
