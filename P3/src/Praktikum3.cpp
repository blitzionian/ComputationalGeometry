...
const string FILE_TEST5 = "input/s_12500_1.dat";
const string FILE_TEST6 = "input/s_12500_2.dat";
const string FILE_TEST7 = "input/s_6250_1.dat";
const string FILE_TEST8 = "input/s_6250_2.dat";
...
//	cout << endl;
//	calculateFile(FILE_TEST5);
//	cout << endl;
//	calculateFile(FILE_TEST6);
//	cout << endl;
//	calculateFile(FILE_TEST7);
//	cout << endl;
